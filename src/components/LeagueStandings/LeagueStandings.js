    ...
    <span
      className={
        classNames(
          ...
          status.startsWith("view") ? "bg-black-100 text-white-800" : null,
        )
      }
    >
      {status}
...
export function ViewLeaguePill({ value }) {
    ...
    <span
      className={
        classNames(
          ...
          role.startsWith("view league") ? "bg-black text-white" : null,
        )
      }
    >
      {role}
...
function LeagueStandings({ columns, data }) {
